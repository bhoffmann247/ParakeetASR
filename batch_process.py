#!/usr/bin/env python3
"""
Batch processing script for transcribing and diarizing audio files
Processes all WAV files in Input/ContactCenter and saves results to Output folder
"""
...
def main():
    ...
    for i, wav_file in enumerate(wav_files, 1):
        logger.info(f"Processing file {i}/{len(wav_files)}: {os.path.basename(wav_file)}")
        try:
